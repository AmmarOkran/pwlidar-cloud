...
def create_map_job(config, internal_storage, executor_id, job_id, map_function, iterdata, runtime_meta,
                   runtime_memory=None, extra_params=None, extra_env=None, partition_type=None, obj_rows=None,
                   obj_cols=None, invoke_pool_threads=128, include_modules=[], exclude_modules=[],
    ...
    if utils.is_object_processing_function(map_function):
        ...
        map_iterdata, parts_per_object = create_partitions(config, map_iterdata, obj_rows, obj_cols, partition_type)
    # ########
